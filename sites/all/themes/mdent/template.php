 ...
 * Page alter.
 */
function mdent_page_alter($page) {
 ...
 */
function mdent_preprocess_html(&$variables) {
	/**
	 * Add IE8 Support
	 */
	...
	*/
    ...
    if (theme_get_setting('mdent_css_cdn', 'mdent')) {
        $cdn = '//maxcdn.mdentcdn.com/mdent/' . theme_get_setting('mdent_css_cdn', 'mdent')  . '/css/mdent.min.css';
        drupal_add_css($cdn, array('type' => 'external'));
    }
    
    if (theme_get_setting('mdent_js_cdn', 'mdent')) {
        $cdn = '//maxcdn.mdentcdn.com/mdent/' . theme_get_setting('mdent_js_cdn', 'mdent')  . '/js/mdent.min.js';
	...
	*/
	if (theme_get_setting('scrolltop_display', 'mdent')) {
 ...
 */
function mdent_process_html(&$vars) {
 ...
 */
function mdent_preprocess_page(&$vars) {
 ...
 */
function mdent_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function mdent_preprocess_block(&$variables) {
 ...
 */
function mdent_breadcrumb($variables) {
 ...
 */
function mdent_form_alter(&$form, &$form_state, $form_id) {
